...
public abstract class BaseEntity implements Serializable {
     ...
     */
    @Nonnull
    public static <T> List<T> convert(@Nonnull Iterable<? extends BaseEntity> iterable, @Nonnull Class<T> clazz) {
    ...
    public static <T> List<T> convert(@Nonnull Collection<? extends BaseEntity> collection, @Nonnull Class<T> clazz) {
        return convert(collection.stream(), clazz);
    }
     ...
     */
    @Nonnull
    public static <T> List<T> convert(@Nonnull Stream<? extends BaseEntity> stream, @Nonnull Class<T> clazz) {
        return stream.map(entity -> entity.convert(clazz)).collect(Collectors.toList());
    }
