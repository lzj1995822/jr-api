package com.cloudkeeper.leasing.identity.dto.centeruser;
 ...
 * @author wj
 */
@ApiModel(value = "分中心人员 查询DTO", description = "分中心人员 查询DTO")
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class CenterUserSearchable extends BaseSearchable {
