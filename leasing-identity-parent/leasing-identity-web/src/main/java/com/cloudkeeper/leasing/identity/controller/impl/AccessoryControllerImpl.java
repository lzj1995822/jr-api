...
public class AccessoryControllerImpl implements AccessoryController {
    ...
    @Override
    public Result<AccessoryVO> add(@ApiParam(value = "系统附件 DTO", required = true) @RequestBody AccessoryDTO accessoryDTO) {
        Accessory accessory = accessoryService.save(accessoryDTO.convert(Accessory.class));
