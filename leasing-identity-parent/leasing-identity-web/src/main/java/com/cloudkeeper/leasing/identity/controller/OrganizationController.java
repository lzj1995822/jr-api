...
public interface OrganizationController {
    ...
    @ApiOperation(value = "可选上级职位列表查询", notes = "可选上级职位列表查询")
    @GetMapping("/list/parentPosition/{id}")
    Result<Map<String, String>> listParentPosition(@ApiParam(value = "组织id", required = true) @PathVariable String id);
