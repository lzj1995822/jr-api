...
public class OrganizationControllerImpl implements OrganizationController {
    ...
    @Override
    public Result<Map<String, String>> listParentPosition(@ApiParam(value = "组织id", required = true) @PathVariable String id) {
        List<Organization> organizationList = organizationService.listParentPosition(id);
        Map<String, String> map = BeanConverts.propertyToMap(organizationList, "id", "name");
