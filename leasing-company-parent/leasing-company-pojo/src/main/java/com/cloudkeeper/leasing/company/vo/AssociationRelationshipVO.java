 ...
 * @author asher
 */
@ApiModel(value = "关联关系 VO", description = "关联关系 VO")
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class AssociationRelationshipVO extends BaseVO {
    ...
    /** 客户名字 */
    @ApiModelProperty(value = "客户名字", position = 31)
    private String customerName;

    /** 关联客户名字 */
    @ApiModelProperty(value = "关联客户名字", position = 32)
