...
public interface CommonCompanyController {
    ...
    Result<CommonCompanyVO> findHis(@ApiParam(value = "客户、担保公司、供应商父表id", required = true) @PathVariable String id) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException;
